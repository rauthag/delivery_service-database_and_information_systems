...
IF OBJECT_ID('ShipmentHistory', 'U') IS NOT NULL
  DROP TABLE ShipmentHistory

IF OBJECT_ID('ShipmentMovement', 'U') IS NOT NULL
  DROP TABLE ShipmentMovement

IF OBJECT_ID('ShipmentProduct', 'U') IS NOT NULL
...
CREATE TABLE "storage" (
    storageid    INTEGER NOT NULL IDENTITY(1,1),
